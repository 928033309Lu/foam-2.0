                  ...
                  <el-form-item label="兴趣区域：">
                    <!-- <div class="interest-area">
                        ...
                        <div class="west-north">
                          ...
                          <el-form-item prop="minX" required>
                            <el-input
                              ...
                              ref="minX"
                              @blur="drawRect('minX')"
                              @keyup.enter.native="inputBlur('minX')"
                              placeholder="X-投影系坐标"
                            ></el-input>
                          </el-form-item>
                          <el-form-item prop="maxY" required>
                            <el-input
                              ...
                              ref="maxY"
                              @blur="drawRect('maxY')"
                              @keyup.enter.native="inputBlur('maxY')"
                              placeholder="Y-投影系坐标"
                            ></el-input>
                          </el-form-item>
                        </div>
                        <div class="east-south">
                          ...
                          <el-form-item prop="maxX" required>
                            <el-input
                              ...
                              ref="maxX"
                              @blur="drawRect('maxX')"
                              @keyup.enter.native="inputBlur('maxX')"
                              placeholder="X-投影系坐标"
                            ></el-input>
                          </el-form-item>
                          <el-form-item prop="minY" required>
                            <el-input
                              ...
                              ref="minY"
                              @blur="drawRect('minY')"
                              @keyup.enter.native="inputBlur('minY')"
                              placeholder="Y-投影系坐标"
                            ></el-input>
                          </el-form-item>
                        </div>
                      ...
                      <div
                        v-if="status <= 1"
                        class="handle-map"
                        :class="{'active': mapEditMode==='rect'&&ind===null}"
                        @click.stop="changeMapEditMode('rect')"
                      >
...
import uploadMapFile from "@/components/project/upload-map-file.vue";
...
export default {
  ...
  methods: {
    ...
    // 上传地图文件触发修改文件
    setMapLayer(type, data) {
      if (type == "terrain") {
        this.conventionalSigns = data.conventionalSigns;
      }
      this.form[type] = data;
    },
    // 机位点/测风塔激活按钮点击事件
